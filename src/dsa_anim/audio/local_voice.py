...
from dsa_anim.audio.timings import AudioTimingData, SceneAudioTiming
from dsa_anim.dsl.retime import estimate_scene_duration
...
class LocalVoiceConfig:
    ...
    def from_sources(
        ...
        *,
        ...
        return cls(
            model_path=_option_or_env_path(model_path, "DSA_ANIM_SHERPA_MODEL"),
            tokens_path=_option_or_env_path(tokens_path, "DSA_ANIM_SHERPA_TOKENS"),
            data_dir=_option_or_env_path(data_dir, "DSA_ANIM_SHERPA_DATA_DIR"),
            lexicon_path=_option_or_env_path(lexicon_path, "DSA_ANIM_SHERPA_LEXICON"),
            rule_fsts=rule_fsts or os.getenv("DSA_ANIM_SHERPA_RULE_FSTS"),
            speaker_id=_option_or_env_int(speaker_id, "DSA_ANIM_SHERPA_SPEAKER", default=0),
            speed=_option_or_env_float(speed, "DSA_ANIM_SHERPA_SPEED", default=1.0),
            pad_seconds=_option_or_env_float(pad_seconds, "DSA_ANIM_SHERPA_PAD", default=0.8),
            binary_name=binary_name or os.getenv("DSA_ANIM_SHERPA_BIN") or DEFAULT_SHERPA_BINARY,
        )
...
def _resolve_sherpa_config(config: LocalVoiceConfig) -> _ResolvedSherpaConfig:
    ...
    if model_path is None:
        raise ValueError(
            ...
            "Pass --voice-model or set DSA_ANIM_SHERPA_MODEL."
        )
    ...
    tokens_path = _resolve_required_path(
        ...
        env_name="DSA_ANIM_SHERPA_TOKENS",
    ...
    data_dir = _resolve_required_path(
        ...
        env_name="DSA_ANIM_SHERPA_DATA_DIR",
